...
--
-- Host: localhost
-- Generation Time: 09-Dez-2015 às 14:53
...
--
-- Estrutura da tabela `tb_adicionais`
--
...
--
-- Estrutura da tabela `tb_entragador`
--
...
INSERT INTO `tb_funcionario` (`cd_funcionario`, `no_funcionario`, `login`, `senha`) VALUES
...
--
-- Estrutura da tabela `tb_pedido_adicionais`
--
...
--
-- Estrutura da tabela `tb_pedido_bebida`
--
...
--
-- Estrutura da tabela `tb_pedido_pizza`
--
...
--
-- Estrutura da tabela `tb_pizza_medida`
--
...
ALTER TABLE `tb_entrega`
  ...
  ADD KEY `fk_tb_entrega_tb_pedido1_idx` (`cd_pedido`),
  ADD KEY `fk_tb_entrega_tb_entragador1_idx` (`cd_entragador`);
...
ALTER TABLE `tb_pedido`
  ...
  ADD KEY `fk_tb_pedido_tb_funcionario1_idx` (`cd_funcionario`),
  ADD KEY `fk_tb_pedido_tb_cliente1_idx` (`cd_cliente`);

--
-- Indexes for table `tb_pedido_adicionais`
--
ALTER TABLE `tb_pedido_adicionais`
  ADD PRIMARY KEY (`cd_pedido`,`cd_adicionais`),
  ADD KEY `fk_tb_pedido_has_tb_adicionais_tb_adicionais1_idx` (`cd_adicionais`),
  ADD KEY `fk_tb_pedido_has_tb_adicionais_tb_pedido1_idx` (`cd_pedido`);

--
-- Indexes for table `tb_pedido_bebida`
--
ALTER TABLE `tb_pedido_bebida`
  ADD PRIMARY KEY (`cd_pedido`,`cd_bebida`),
  ADD KEY `fk_tb_pedido_has_tb_bebida_tb_bebida1_idx` (`cd_bebida`),
  ADD KEY `fk_tb_pedido_has_tb_bebida_tb_pedido1_idx` (`cd_pedido`);

--
-- Indexes for table `tb_pedido_pizza`
--
ALTER TABLE `tb_pedido_pizza`
  ADD PRIMARY KEY (`cd_pedido`,`cd_pizza`),
  ADD KEY `fk_tb_pedido_has_tb_pizza_tb_pizza1_idx` (`cd_pizza`),
  ADD KEY `fk_tb_pedido_has_tb_pizza_tb_pedido1_idx` (`cd_pedido`);

--
-- Indexes for table `tb_pizza`
--
ALTER TABLE `tb_pizza`
  ADD PRIMARY KEY (`cd_pizza`,`tb_pizza_medida_cd_tamanho`),
  ADD KEY `fk_tb_pizza_tb_pizza_medida_idx` (`tb_pizza_medida_cd_tamanho`);
...
--
ALTER TABLE `tb_entragador`
  MODIFY `cd_entragador` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tb_entrega`
--
ALTER TABLE `tb_entrega`
  MODIFY `cd_entrega` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tb_pedido`
  MODIFY `cd_pedido` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=40;
--
-- AUTO_INCREMENT for table `tb_pizza`
--
ALTER TABLE `tb_pizza`
  MODIFY `cd_pizza` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `tb_pizza_medida`
--
ALTER TABLE `tb_pizza_medida`
  MODIFY `cd_tamanho` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
...
--
-- Limitadores para a tabela `tb_pedido_adicionais`
--
ALTER TABLE `tb_pedido_adicionais`
...
--
-- Limitadores para a tabela `tb_pedido_bebida`
--
ALTER TABLE `tb_pedido_bebida`
...
--
-- Limitadores para a tabela `tb_pedido_pizza`
--
ALTER TABLE `tb_pedido_pizza`
...
--
-- Limitadores para a tabela `tb_pizza`
--
ALTER TABLE `tb_pizza`
